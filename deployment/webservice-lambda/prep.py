...
RUN_ID ="5651db4644334361b10296c51ba3af3e" # os.getenv("RUN_ID")  # 
S3_BUCKET_NAME = "mlops-project-sales-forecast-bucket" #os.getenv("S3_BUCKET_NAME")
EXPERIMENT_ID = 1
...
def init(event):
    """
    Fetches the event and outputs the predicted sales
    """
    find = event["find"]
